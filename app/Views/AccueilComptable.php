...
<body style="background-image: url('<?php echo base_url('public/images/couloir0.jpg'); ?>');">
  <nav>
    <ul class="sidebar">
      <li><a href="getdata?action=accueil">Accueil</a></li>
      <li><a href="getdata?action=RFF">Renseigner Fiche Frais</a></li>
      <li><a href="getdata?action=CFF">Consulter Fiche Frais</a></li>
      <li><a href="getdata?action=deco">Déconnexion</a></li>
    </ul>
    <ul>
      <li><a href="#">GSB.</a></li>
